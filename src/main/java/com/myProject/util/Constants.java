...
public class Constants {
    ...
    public static final String SELECT_ALL_ORDERS = "SELECT `id`, `user_id`, `time`, `totalAmount` FROM `order` WHERE `direction` = 'OUT'";
    ...
    public static final String LIST_OF_PRODUCT_COMMAND = "List of product";
